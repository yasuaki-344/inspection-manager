...
public class ExcelDownloadService : IExcelDownloadService
{
    ...
    private static void WriteCell(ISheet sheet, int rowIndex, int columnIndex, string value)
    {
    ...
    private static ICellStyle CreateHeadingCellStyle(IWorkbook book, IFont font)
    {
    ...
    private static ICellStyle CreateUpperHeadingCellStyle(IWorkbook book, IFont font)
    {
        var cellStyle = book.CreateCellStyle();
        // font
        cellStyle.SetFont(font);
    ...
    private static ICellStyle CreateMediumHeadingCellStyle(IWorkbook book, IFont font)
    {
        var cellStyle = book.CreateCellStyle();
        // font
        cellStyle.SetFont(font);
    ...
    private static ICellStyle CreateLowerHeadingCellStyle(IWorkbook book, IFont font)
    {
        var cellStyle = book.CreateCellStyle();
        // font
        cellStyle.SetFont(font);
    ...
    private static ICellStyle CreateBasicCellStyle(IWorkbook book, IFont font)
    {
        var cellStyle = book.CreateCellStyle();
        // font
        cellStyle.SetFont(font);
